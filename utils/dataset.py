...
def mp_pool_map(list_input, func, num_workers):
    ...
    print(f"\nStart conversion processing, data volume: {len(list_input)}, Number of processes: {num_workers}")
        ...
        def __call__(self, data_list):
            ...
            for data in data_list:
                ...
                try:
                    ...
                    print(f"Error processing data {index}: {str(e)}")
    ...
    def _load_npz_data_path(self, npz_path):
        ...
        try:
            if npz_path.endswith('.npz'):
                ...
                raise ValueError(f"Invalid path: {npz_path}")
